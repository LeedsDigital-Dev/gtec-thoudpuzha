...
## Corpus Check
- 241 files · ~69,733 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1075 nodes · 1905 edges · 78 communities (65 shown, 13 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `14114787`
...
Cohesion: 0.13
Nodes (19): approveJobPosting(), editAndApproveJobPosting(), localeFromFormData(), rejectJobPosting(), mockAuditCreate, mockAuth, mockFindMany, mockRedirect (+11 more)
...
Cohesion: 0.06
Nodes (38): PublicLayout(), NewsPage(), NewsPageProps, NewsDetailPage(), NewsDetailPageProps, HomePage(), HomePageProps, AboutSection() (+30 more)
...
Cohesion: 0.07
Nodes (74): createPartner(), deletePartner(), localeFromFormData(), movePartner(), updatePartner(), PageProps, createCategory(), createCourse() (+66 more)

### Community 24 - "gallery/actions.ts"
Cohesion: 0.08
Nodes (7): AuditLogPage(), AuditLogPageProps, EnquiriesPage(), EnquiriesPageProps, STATUS_STYLES, TILES, globalForPrisma
...
Cohesion: 0.13
Nodes (12): STATUS_BADGE, ActionResult, PortalRoleGate(), PortalRoleGateProps, ROLE_LABELS, RequirePermissionResult, requirePortalRole(), RequireRoleResult (+4 more)
...
Cohesion: 0.05
Nodes (40): AdminLayout(), PortalLayout(), ContactSection(), ContactSectionProps, socialIcons, baseSettings, mockCourses, CourseSelect() (+32 more)
...
Cohesion: 0.06
Nodes (57): submitVacancy(), PostVacancyPage(), JOB_TYPES, PostVacancyForm(), PostVacancyFormProps, RegistrationResult, submitEmployerRegistration(), mockAuth (+49 more)
...
Cohesion: 0.16
Nodes (21): approveAndTrustEmployer(), approveEmployer(), localeFromFormData(), rejectEmployer(), mockAuditCreate, mockAuth, mockFindMany, mockFindUnique (+13 more)
...
Cohesion: 0.13
Nodes (13): BiodataActionResult, BiodataFormData, saveBiodata(), BiodataPage(), getPublishedCourses(), MockCourse, mockCourseCreate, mockCourseFindMany (+5 more)
...
- **Why does `Role` connect `FlashNewsBar.tsx` to `EmployerModerationNotification.tsx`, `courses.test.ts`, `news-events.test.ts`, `EnquiryForm.tsx`, `search-form.tsx`, `[id]/actions.ts`, `BiodataForm.test.tsx`, `FlashNewsBar.tsx`, `[id]/page.tsx`, `students/actions.test.ts`, `actions.test.ts`, `courses.test.ts`, `Role`, `student-dashboard.test.tsx`, `FlashNewsBar.tsx`, `assignments/page.tsx`, `gallery/actions.ts`, `portal/student/page.tsx`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `requireRole()` connect `FlashNewsBar.tsx` to `EmployerModerationNotification.tsx`, `courses.test.ts`, `FlashNewsBar.tsx`, `package.json`, `EnquiryForm.tsx`, `BiodataForm.test.tsx`, `students/actions.test.ts`, `actions.test.ts`, `courses.test.ts`, `gallery/actions.ts`?**
