...
## Corpus Check
- 154 files · ~38,000 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 680 nodes · 1113 edges · 49 communities (39 shown, 10 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `71d04c53`
...
1. `requireRole()` - 50 edges
2. `logAdminAction()` - 31 edges
3. `Role` - 28 edges
4. `cn()` - 19 edges
...
Cohesion: 0.13
Nodes (19): CertificationPartnersPage(), CertificationPartnerStrip(), GalleryGrid(), getEmbedUrl(), getVideoThumbnail(), getVimeoEmbedUrl(), getYouTubeEmbedUrl(), getYouTubeVideoId() (+11 more)
...
Cohesion: 0.08
Nodes (33): GalleryPage(), GalleryPageProps, NewsPage(), NewsPageProps, NewsDetailPage(), NewsDetailPageProps, HomePage(), HomePageProps (+25 more)
...
Cohesion: 0.11
Nodes (18): BiodataActionResult, BiodataFormData, CandidateProfileWithCompletion, isProfileComplete(), saveBiodata(), BiodataPage(), BiodataForm(), BiodataFormProps (+10 more)
...
Cohesion: 0.06
Nodes (57): AuditLogPage(), AuditLogPageProps, EnquiriesPage(), EnquiriesPageProps, createFlashNews(), deleteFlashNews(), localeFromFormData(), moveFlashNews() (+49 more)
...
## Knowledge Gaps
- **281 isolated node(s):** `mockAuth`, `mockClerkClient`, `mockUpdateUser`, `mockUpsert`, `mockFindUnique` (+276 more)
...
- **Why does `requireRole()` connect `FlashNewsBar.tsx` to `courses.test.ts`, `package.json`, `biodata/page.tsx`, `actions.test.ts`, `FlashNewsBar.tsx`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **Why does `Role` connect `FlashNewsBar.tsx` to `courses.test.ts`, `news-events.test.ts`, `biodata/page.tsx`, `actions.test.ts`, `FlashNewsBar.tsx`, `(public)/page.tsx`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **Why does `LanguageSwitcher()` connect `aliases` to `FlashNewsBar.tsx`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
- **What connects `mockAuth`, `mockClerkClient`, `mockUpdateUser` to the rest of the system?**
