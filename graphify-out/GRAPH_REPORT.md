...
## Corpus Check
- 353 files · ~125,303 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1696 nodes · 2909 edges · 157 communities (128 shown, 29 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 3 edges (avg confidence: 0.6)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `20858f0b`
...
Cohesion: 0.05
Nodes (43): @aws-sdk/client-s3, @base-ui/react, class-variance-authority, @clerk/nextjs, clsx, inngest, lucide-react, @neondatabase/serverless (+35 more)
...
Cohesion: 0.06
Nodes (36): submitEmployerRegistration(), mockAuth, mockCheckRateLimit, mockClerkClient, mockCreate, mockFindUnique, mockGetClientIp, mockRedirect (+28 more)
...
Cohesion: 0.33
Nodes (5): EmployerPortalLayout(), EmployerShell(), EmployerShellProps, EmployerSidebar(), isRouteActive()
...
Cohesion: 0.19
Nodes (12): react, react, renderWithProvider(), JobSeekerShell(), JobSeekerShellProps, StudentShell(), StudentShellProps, Sidebar() (+4 more)
...
Cohesion: 0.11
Nodes (29): Separator(), Sheet(), SheetContent(), SheetDescription(), SheetFooter(), SheetHeader(), SheetOverlay(), SheetTitle() (+21 more)
...
Cohesion: 0.28
Nodes (5): BiodataPdfData, BiodataPdfDocument(), styles, completeData, incompleteData
...
Cohesion: 0.06
Nodes (53): PostVacancyFormProps, EMPLOYEE_RANGES, RegistrationForm(), RegistrationFormProps, SECTORS, JobsFilter(), JobsFilterProps, BiodataFormData (+45 more)
...
Cohesion: 0.06
Nodes (29): AdminLayout(), PortalLayout(), AdminShell(), CourseDropdownItem, CoursesDropdown(), CoursesDropdownProps, mockCourses, Footer() (+21 more)
...
Cohesion: 0.08
Nodes (23): GET(), JOB_TYPE_LABELS, QUALIFICATION_LABELS, EmployerDashboardPage(), EmployerDashboardPageProps, EmployerProfilePage(), ProfilePageProps, RegistrationResult (+15 more)
...
Cohesion: 0.17
Nodes (17): isRouteActive(), JobSeekerSidebar(), isRouteActive(), StudentSidebar(), SidebarContent(), SidebarFooter(), SidebarGroup(), SidebarGroupLabel() (+9 more)
...
Cohesion: 0.12
Nodes (15): PostVacancyPage(), JobsPage(), JobsPageProps, BiodataActionResult, saveBiodata(), submitBiodataForm(), BiodataPage(), PlacementPage() (+7 more)
...
## Knowledge Gaps
- **817 isolated node(s):** `workflow`, `name`, `version`, `private`, `dev` (+812 more)
