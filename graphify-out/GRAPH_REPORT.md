...
## Corpus Check
- 353 files · ~124,765 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1696 nodes · 2913 edges · 156 communities (127 shown, 29 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 3 edges (avg confidence: 0.6)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c2bf8dc9`
...
Cohesion: 0.22
Nodes (8): EmployerPortalLayout(), EmployerShell(), EmployerShellProps, JobSeekerShell(), JobSeekerShellProps, StudentShell(), StudentShellProps, SidebarTrigger()
...
## Knowledge Gaps
- **817 isolated node(s):** `name`, `version`, `private`, `dev`, `build` (+812 more)
