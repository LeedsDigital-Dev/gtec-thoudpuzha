    ...
    <div ref={containerRef} className="relative inline-flex items-center" onKeyDown={handleArrowKeys}>
      ...
      {open && (
        <div
          ...
          className={cn(
            "absolute top-full left-1/2 -translate-x-1/4 sm:-translate-x-1/3 md:-translate-x-1/2 mt-2.5 rounded-2xl border border-slate-200/80 bg-white/98 backdrop-blur-2xl text-slate-800 p-4 shadow-xl z-50 animate-in fade-in-50 zoom-in-95 duration-150",
            useThreeColumns
        ...
        >
          <div className="flex items-center justify-between border-b border-slate-100 pb-3 mb-3 px-1">
            ...
            <Link
              href="/courses"
              role="menuitem"
              className="text-sm font-semibold text-primary hover:text-primary/80 hover:underline inline-flex items-center gap-1 group"
              tabIndex={-1}
            >
