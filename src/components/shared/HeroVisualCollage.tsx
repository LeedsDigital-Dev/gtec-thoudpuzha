  ...
  return (
    <div className="relative w-full max-w-[520px] sm:max-w-[580px] lg:max-w-[620px] xl:max-w-[660px] mx-auto lg:ml-auto lg:mr-0 select-none py-4 sm:py-6">
      ...
      <div className="relative flex items-center justify-center min-h-[300px] sm:min-h-[360px] md:min-h-[400px] lg:min-h-[420px]">
        {/* Secondary Left Layered Panel: AI / Technology Student */}
        <div className="absolute left-0 sm:left-1 md:left-2 top-[12%] sm:top-[10%] w-[44%] sm:w-[43%] aspect-[4/5] z-10 transform -rotate-2 sm:-rotate-3 transition-transform duration-500 hover:rotate-0 hover:z-25">
          <div className="relative w-full h-full overflow-hidden rounded-2xl sm:rounded-3xl border border-white/80 dark:border-white/20 bg-card shadow-xl shadow-blue-950/15">
            <Image
        ...
        {/* Secondary Right Layered Panel: Coding & Analytics HUD */}
        <div className="absolute right-0 sm:right-1 md:right-2 bottom-[8%] sm:bottom-[7%] w-[44%] sm:w-[43%] aspect-[4/5] z-10 transform rotate-2 sm:rotate-3 transition-transform duration-500 hover:rotate-0 hover:z-25">
          <div className="relative w-full h-full overflow-hidden rounded-2xl sm:rounded-3xl border border-white/80 dark:border-white/20 bg-card shadow-xl shadow-blue-950/15">
            <Image
        ...
        {/* Main Center Focal Image: Professional Business & AI Technology */}
        <div className="relative z-20 w-[58%] sm:w-[56%] md:w-[54%] lg:w-[56%] xl:w-[55%] aspect-[3/4] transition-transform duration-500 hover:scale-[1.02]">
          <div className="relative w-full h-full overflow-hidden rounded-2xl sm:rounded-3xl border-2 border-white/95 dark:border-white/25 bg-card shadow-2xl shadow-blue-950/30 ring-1 ring-primary/20">
            <Image
