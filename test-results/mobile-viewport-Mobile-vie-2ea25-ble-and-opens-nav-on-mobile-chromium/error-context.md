...
- Name: mobile-viewport.spec.ts >> Mobile viewport (375px) smoke tests >> hamburger menu button is visible and opens nav on mobile
- Location: tests/e2e/mobile-viewport.spec.ts:6:7
