...
- Name: mobile-viewport.spec.ts >> Mobile viewport (375px) smoke tests >> WhatsApp CTA is tappable without overflow on mobile
- Location: tests/e2e/mobile-viewport.spec.ts:25:7
