...
- Name: mobile-viewport.spec.ts >> Mobile viewport (375px) smoke tests >> all navigation items accessible from hamburger menu
- Location: tests/e2e/mobile-viewport.spec.ts:45:7
