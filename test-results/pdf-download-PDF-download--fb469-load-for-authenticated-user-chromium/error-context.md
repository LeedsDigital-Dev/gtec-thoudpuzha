...
- Name: pdf-download.spec.ts >> PDF download flow — WebKit engine >> biodata page contains link/button to PDF download for authenticated user
- Location: tests/e2e/pdf-download.spec.ts:16:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/en/portal/student/biodata
Call log:
  - navigating to "http://localhost:3000/en/portal/student/biodata", waiting until "load"
