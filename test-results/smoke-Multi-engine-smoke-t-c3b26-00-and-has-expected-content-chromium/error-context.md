...
- Name: smoke.spec.ts >> Multi-engine smoke test — public pages >> GET /en/news returns 200 and has expected content
- Location: tests/e2e/smoke.spec.ts:15:9

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/en/news
Call log:
  - navigating to "http://localhost:3000/en/news", waiting until "load"
